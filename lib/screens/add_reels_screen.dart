...
import 'package:instagram/screens/reels_edits_screen.dart';
...
class _AddReelsScreenState extends State<AddReelsScreen> {
  ...
  void initState() {
    super.initState();
    _fetchNewMedia(); // Fetch media when the widget initializes
  }
                    ...
                    if (asset.type == AssetType.video)
                      Align(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              Text(asset.videoDuration.inMinutes.toString(),
                                  style: TextStyle(
                              ...
                              Text(':',
                                  style: TextStyle(
                                      fontWeight: FontWeight.w500,
                                      color: Colors.white)),
                              Text(asset.videoDuration.inSeconds.toString(),
                                  style: TextStyle(
                                      fontWeight: FontWeight.w500,
                                      color: Colors.white)),
                            ],
